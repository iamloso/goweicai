CREATE TABLE `zp_jj` (
    ...
    `auction_unmatched_amount_rank` varchar(50) DEFAULT NULL COMMENT '竞价未匹配金额排名',
...
) ENGINE = InnoDB AUTO_INCREMENT = 10563 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '竞价数据表';